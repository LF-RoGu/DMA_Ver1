...
void DMA_init(void)
{
	...
	DMA0->TCD[0].SOFF = 4;/*2 Source address signed offset;it is expressed in number of bytes*/
	...
	DMA0->TCD[0].NBYTES_MLNO = 6;/*byte number*/ /*cuantos bytes quiero transferir*/
